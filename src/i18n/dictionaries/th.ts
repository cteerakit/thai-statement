...
export const dictionary: Dictionary = {
  ...
  home: {
    ...
    subtitle:
      "อัปโหลดสเตทเมนต์ PDF ดิจิทัลแล้วดาวน์โหลดไฟล์ CSV หรือ Excel ที่จัดรูปแบบแล้ว ไม่ต้องมีบัญชี — เข้าสู่ระบบเมื่อต้องการบันทึกประวัติเท่านั้น",
    ...
    featurePrivateBody:
      "ไม่เก็บ PDF ของคุณ เว้นแต่เข้าสู่ระบบและเลือกบันทึกประวัติ",
  ...
  upload: {
    ...
    saveHistory:
      "บันทึกในประวัติของฉัน (30 วัน เฉพาะรายการ — ไม่เก็บ PDF)",
  ...
  history: {
    title: "ประวัติการแปลง",
    subtitle: "เก็บไว้ 30 วัน ไม่บันทึก PDF",
    unavailableTitle: "ประวัติไม่พร้อมใช้งาน",
    unavailableDescription:
      "ตั้งค่า DATABASE_URL และรัน migration เพื่อเปิดใช้ประวัติ",
    empty:
      'ยังไม่มีรายการที่บันทึก แปลงสเตทเมนต์แล้วเลือก "บันทึกในประวัติของฉัน"',
    rows: "แถว",
    expires: "หมดอายุ",
    back: "← กลับไปแปลงสเตทเมนต์",
  },
  privacy: {
    ...
    collectAnonymous:
      "เมื่อแปลงโดยไม่เข้าสู่ระบบ เราประมวลผล PDF ในหน่วยความจำเท่านั้น และไม่เก็บไฟล์ PDF",
    collectSignedIn:
      "หากเข้าสู่ระบบและเลือกบันทึกประวัติ เราเก็บเฉพาะแถวรายการที่ดึงออกมา (ไม่เก็บ PDF) เป็นระยะเวลา 30 วัน เพื่อให้ดาวน์โหลดซ้ำได้",
    ...
    limitsBody:
      "การแปลงแบบไม่ระบุตัวตนถูกจำกัดตาม IP เพื่อป้องกันการใช้งานในทางที่ผิด",
    contactTitle: "ติดต่อ",
    contactBody:
